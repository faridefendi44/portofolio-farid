...
const index = () => {
  ...
  return (
    <div className="">
      ...
      ></motion.div>
      <div className="xl:flex space-y-14 xl:space-y-0 justify-center w-full mx-0 xl:justify-between xl:px-36 mx-auto  h-screen pt-36 xl:pt-0 my-auto items-center">
